...

{
  ...
  shape_bool: $color_palette.lavender
  shape_custom: $color_palette.green
  shape_datetime: { fg: $color_palette.peach attr: "i" }
  shape_directory: { fg: $color_palette.sky attr: "i" }
  shape_external: $color_palette.lavender
  shape_externalarg: { fg: $color_palette.rosewater }
  shape_filepath: $color_palette.sky
  shape_flag: { fg: $color_palette.blue attr: "b" }
  shape_float: { fg: $color_palette.peach attr: "i" }
  shape_garbage: { fg: $color_palette.base bg: $color_palette.red attr: "b" }
  shape_globpattern: { fg: $color_palette.teal attr: "b" }
  shape_int: $color_palette.peach
  shape_internalcall: { fg: $color_palette.lavender attr: "i" }
  shape_list: $color_palette.overlay2
  shape_literal: $color_palette.blue
  shape_match_pattern: $color_palette.green
  shape_matching_brackets: { attr: "u" }
  shape_nothing: $color_palette.teal
  shape_operator: $color_palette.sapphire
  ...
  shape_variable: $color_palette.yellow
