...
let catppuccin_theme = {
  ...
  header: { fg: $catppuccin_mocha_palette.blue attr: "b" }
  ...
  row_index: { fg: $catppuccin_mocha_palette.mauve attr: "b" }
  ...
  shape_bool: $catppuccin_mocha_palette.lavender
  shape_custom: $catppuccin_mocha_palette.green
  shape_datetime: { fg: $catppuccin_mocha_palette.peach attr: "i" }
  shape_directory: { fg: $catppuccin_mocha_palette.sky attr: "i" }
  shape_external: $catppuccin_mocha_palette.lavender
  shape_externalarg: { fg: $catppuccin_mocha_palette.rosewater }
  shape_filepath: $catppuccin_mocha_palette.sky
  shape_flag: { fg: $catppuccin_mocha_palette.blue attr: "b" }
  shape_float: { fg: $catppuccin_mocha_palette.peach attr: "i" }
  shape_garbage: { fg: $catppuccin_mocha_palette.base bg: $catppuccin_mocha_palette.red attr: "b" }
  shape_globpattern: { fg: $catppuccin_mocha_palette.teal attr: "b" }
  shape_int: $catppuccin_mocha_palette.peach
  shape_internalcall: { fg: $catppuccin_mocha_palette.lavender attr: "i" }
  shape_list: $catppuccin_mocha_palette.overlay2
  ...
  shape_operator: $catppuccin_mocha_palette.sapphire
  ...
  shape_variable: $catppuccin_mocha_palette.yellow
...
let fish_completer = {|spans|
    /usr/bin/env fish --command $'complete "--do-complete=($spans | str join " ")"'
...
$env.config = {
    ...
    explore: {
        status_bar_background: { fg: $catppuccin_mocha_palette.base, bg: $catppuccin_mocha_palette.lavender },
        command_bar_text: { fg: $catppuccin_mocha_palette.lavender },
        highlight: { fg: $catppuccin_mocha_palette.base, bg: $catppuccin_mocha_palette.yellow },
        status: {
            error: { fg: $catppuccin_mocha_palette.text, bg: $catppuccin_mocha_palette.red },
            warn: {}
            info: {}
        },
        table: {
            split_line: { fg: $catppuccin_mocha_palette.overlay0 },
            selected_cell: { bg: $catppuccin_mocha_palette.lavender },
            selected_row: {},
            selected_column: {},
        },
    }
